...
- Docs: link to the docs page and GitHub Packages install from the README; point "Get an API key" at
  `https://studio.ross-developers.com`.
- Also mirrored to GitHub Packages under the `@ross-sec` scope.
